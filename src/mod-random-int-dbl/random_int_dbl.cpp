/*
 *  File: random_int_dbl.cpp
 *
 *  Version: 1.0 Mar 20, 2020
 *  Version: 2.0 Oct 12, 2020
 *  Version: 3.0 Fri 05 Mar 2021 09:50:05 AM +08
 *  Author: wruslan
 */
...
// ========================================================
    ...
    // START FIX DISPLAY
    bin_boundary[loopnum+1] = bin_boundary[loopnum+1] - (loopnum);

    if (loopnum == 0) {
       printf("Random integers in range[%ld, %ld) = \t", bin_boundary[loopnum], bin_boundary[loopnum+1] - 1);
    } else {
       printf("Random integers in range[%ld, %ld) = \t", bin_boundary[loopnum], bin_boundary[loopnum+1] - 1);
    } // END FIX DISPLAY
...
// ========================================================
    ...
    if (loopnum == 0) {
       ...
       printf("Random doubles in range[%f, %f) = \t", bin_boundary[loopnum] + loopnum, bin_boundary[loopnum+1] + loopnum);
    } // END FIX DISPLAY
